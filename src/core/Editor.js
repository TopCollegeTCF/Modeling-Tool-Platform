...
import { StencilService } from '../services/StencilService.js';
import { StencilTool } from '../tools/StencilTool.js';
import { StencilUI } from '../ui/StencilUI.js';
...
export class Editor {
    constructor() {
        ...
        this.stencilService = new StencilService(this);
    ...
    initScene() {
        ...
        if (this.stencilService) {
            this.stencilService.init(this.sceneManager.getScene());
        }
